...
export const buttonVariants = cva(
  'flex items-center justify-center px-3 py-2.5 cursor-pointer transition-color ease-in-out duration-300',
  {
    variants: {
      variant: {
        primary: 'bg-primary-500 text-button-primary hover:bg-primary-600',
        accent: 'bg-accent-500 text-button-accent hover:bg-accent-600',
      },
      size: {
        large: 'gap-1.5 px-4 py-3 text-lg rounded-md',
        normal: 'gap-1.5 px-3 py-2.5 rounded-sm',
        small: 'gap-0.75 px-2.5 py-2 text-sm rounded-sm',
      },
      disabled: {
